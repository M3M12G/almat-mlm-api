...
namespace AlmatMlm.Api.Data.Migrations
{
    /// <inheritdoc />
    public partial class InitialSchema : Migration
    {
        ...
        {
            // Domain DDL from db/schema.sql (ordered copy under Data/Scripts).
            migrationBuilder.Sql(ReadSchemaSql());
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                ...
                DROP TABLE IF EXISTS rank_achievements;
        ...
        {
            var path = Path.Combine(AppContext.BaseDirectory, "Data", "Scripts", "0001_schema.sql");
            if (!File.Exists(path))
            {
                // Fallback when tools run from project directory.
                path = Path.GetFullPath(Path.Combine("Data", "Scripts", "0001_schema.sql"));
            }
