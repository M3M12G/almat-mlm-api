-- Applied as EF Core initial migration.
-- Source draft: db/schema.sql (order fixed: ranks before users.rank_id FK).
-- Keep in sync with db/schema.sql (AGENTS.md).

CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- ---------- Ранги (до users — FK rank_id) ----------
